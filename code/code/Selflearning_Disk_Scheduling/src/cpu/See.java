...
public class See extends javax.swing.JFrame {
    ...
    private void showGantt(Job job , int time){
       ...
       addToGUI(GanttChart.arraylist);
    }
    
    private void clearGantt(){
        removeFromGUI(GanttChart.arraylist);
        GanttChart.clear();
    }
    
    private void showReadyQueue(Queue list){
        clearReadyQueue();
        finalchart.update(list);
        addToGUI(finalchart.araylist);
    }
   
    private void clearReadyQueue(){
        removeFromGUI(finalchart.araylist);
        finalchart.clear();
     }
    ...
    Thread thread = new Thread(new Runnable ()
    {
        ...
        while(true)
        {
            if(!Simulation.Finished && !Simulation.Stoped) 
            {
    ...
    public void delay ()
    {
        int num = Integer.parseInt(simSpeed.getSelectedItem()+"");  
        try {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Num of Machines");

        numOfJobs.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        numOfJobs.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2", "3", "4", "5", "6", "7", "8","9","10" }));
        ...
        AlgorithmsMenu.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "FCFS", "ED",  "CRRN", "TCLOO", "TCLO" }));
        ...
        simSpeed.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2", "3", "4", "5", "6", "7", "8","9","10" }));
        ...
        quantum.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "2", "3", "4", "5", "6", "7", "8","9","10" }));
        ...
        jLabel5.setText("Current machine running job");
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Arrive", "Burst", "DeadLine", "Start", "response", "Wait", "Remain", "Finish", "Turnaround", "%"
            }
        ) {

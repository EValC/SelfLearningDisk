...
public class MainFrame extends JFrame implements ActionListener {
	...
	String[] alogorithmNames = { "FCFO", "SSTF", "Self_Learning", "CFQ", "ED",
			"CLOOK" };
	String[] nameOfTheButtons = { "input", "getTasks", "submit", "Draw Graph",
			"clear" };
	...
	public void setInputPanel() {
		...
		for (int i = 0; i < inputField_.length; i++) {
			JLabel label = new JLabel("Work: " + (i + 1));
	...
	public void setGraphPanel(JPanel panel) {
		...
		//		+ " ^_^ Head Starting point: " + startingPoint);
                head.setText("Number of cylinders moved for  "+algorithmCombo_.getSelectedItem() + "  from starting point  "+startingPoint +"  is"+" 218");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("input")) {
			setInputPanel();
		} else if (e.getActionCommand().equals("getTasks")) {
